<template>
  <div>
    <div class="u-body">
      <header class="u-clearfix u-header u-header" id="sec-2693">
        <div class="u-clearfix u-sheet u-sheet-1">
          <a href="http://localhost:8080/" class="u-image u-logo u-image-1">
            <img
      ...
      <section class="u-align-center u-clearfix u-section-1" id="carousel_a3ed">
        <div class="u-clearfix u-sheet u-sheet-1">
          ...
          <h4 class="u-text u-text-default u-text-2">
            tensorflow를 활용한 <b>layer</b> 만들기<br />
          </h4>
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-4">
                  모델을 구성하는 요소는 <b>layer</b>라고 할 수 있습니다. 
                  따라서 tensorflow에서 지원하는 <b>layer</b>의 종류에 대해 알아보고, 
                  그 layer를 이용해서 model을 만드는 법에 대해 알아 봅시다.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp; 모델을 구성하는 layer의 종류와 인자들을 알아봅시다. 
                   tensorflow에서는 딥러닝 모델을 만들 때, 아파트를 한 층씩 아래부터 만드는 것 처럼 모델도 한 층(layer)씩 쌓아서 모델을 만듭니다. 
                   즉, layer가 모며 모델이 되므로 쉽게 모델을 만들 수 있고, 모델의 layer도 쉽게 바꿀 수 있다는 것이 tensorflow의 큰 장점입니다. 
                   layer 중에\ 가장 많이 쓰이고 있는 tf.keras.layer의 모듈에 대해 알아봅시다. 
                   순서는 <b>tf.keras.layers.Dense</b>, <b>tf.keras.layers.Dropout</b>, <b>tf.keras.layers.Conv1D</b>, 
                   <b>tf.keras.layers,MaxPool1D</b> 순서로 알아보겠습니다.
                </p>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <blockquote class="u-border-grey-50 u-text u-text-2">
                 ...
                 <br />
                  ...
                  <b>출력값 = 활성화함수 x (가중치행렬 x 입력벡터 + 편향벡터)</b>
 <br /><br />
                </blockquote>
              </div>
            </div>
          ...
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp; 위의 내용을 코드로 구현하려면, 
                  아래와 같이 가중치 변수를 모두 정의해 줘야합니다.(tensorflow에서는 코드 한 줄로 작성 가능합니다.)
                  <br />
                </p>
              </div>
            </div>
        ...
        <div class="">
            ...
            >
              ...
              >
                ...
                <blockquote class="u-border-grey-50 u-text u-text-2">
                  ...
                  W = tf.Variable(tf.random_uniform([5, 10], -1.0, 1.0))<br />
                  b = tf.Variable(tf.zeros([10]))<br />
                  y = tf.matmul(W, x) + b<br /><br />
                </blockquote>
              </div>
            </div>
          </div>
          ...
          <ul class="u-custom-list u-text u-text-3">
            <li>
              ...
              <b>tf.random_uniform 함수는 정규분포 난수를 생성하는 함수로, 배열의 shape, 최소값, 최대값을 파라미터로 사용합니다. 
                즉, 최소값과 최대값 사이의 난수를 생성해서 배열에 넣어줍니다. </b> <b> <br /></b><br />
            ...
            <li>
              ...
              <b>tf.zeros는 적혀진 배열의 shape에 맞게 모든 원소의 값이 0인 텐서를 생성한다. </b> <b> <br /></b>
              <br /><br />
            </li>
          </ul>
        ...
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                <p class="u-text u-text-2">
                  &nbsp;옛날에는 위와 같이 모든 변수들을 선언 후에 하나하나씩 연산을 해줘야했습니다. 
                  그러나 tensorflow에서는 자동으로 만들어줄 뿐만아니라 tensorflow에서는 인자 설정에 따라 
                  활성화 함수 설정, 초기화 방법, 정규화 방법 등 다양한 기능을 쉽게 사용 가능합니다.
                  <br />
                </p>
              </div>
            </div>
        ...
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                <h4 class="u-text u-text-default u-text-1">
                  2-2. tensorflow로 Dense 구현하기
                </h4>
                <p class="u-text u-text-2">
                  &nbsp; 케라스 Dense를 사용하기 위해서는 먼저 객체를 생성해 줍시다.
                </p>
                <p class="u-text u-text-2">
                  <b>dense = tf.keras.layers.Dense(...)</b>
                </p>
                <p class="u-text u-text-2">
                  Dense 객체 생성 시 위의 코드에서 ( ... )부분에 여러 인자를 추가여여 가중치, 초기화 방법, 활성화 함수 같은 여러 옵션을 지정할 수 있습니다. 
                  그 종류에 대해 알아봅시다. 
                  객체 생성 시 지정할 수 있는 인자는 아래와 같습니다.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="">
          ...
          <ul class="u-custom-list u-text u-text-3">
            <li>
              ...
              <b>unit : 출력 값의 크기로 Integer이나 Long 형태다. </b> <b> <br /></b><br />
            ...
            <li>
              ...
              <b>activation : 활성화 함수를 나타낸다. </b> <b> <br /></b>
              <br /><br />
            </li>
            ...
            <li>
              ...
              <b>use_bias : 편향(b)를 사용할지 여부를 나타내고 Boolean 값 형태다. </b> <b> <br /></b>
              <br /><br />
            </li>
                        <li>
              <div class="u-list-icon">
              ...
              <b>kernel_initializer : 가중치(W) 초기화 함수 </b> <b> <br /></b>
              <br /><br />
            </li>
                        <li>
              <div class="u-list-icon">
              ...
              <b>bias_initializer : 편향 초기화 함수 </b> <b> <br /></b>
              <br /><br />
            </li>
                        <li>
              <div class="u-list-icon">
              ...
              <b>kernel_regularizer : 가중치 정규화 방법 </b> <b> <br /></b>
              <br /><br />
            </li>
                        <li>
              <div class="u-list-icon">
              ...
              <b>bias_regularizer : 편향 정규화 방법 </b> <b> <br /></b>
              <br /><br />
            </li>
                        <li>
              <div class="u-list-icon">
              ...
              <b>activity_regularizer :출력 값 정규화 방법</b> <b> <br /></b>
              <br /><br />
            </li>
                        <li>
              <div class="u-list-icon">
              ...
              <b>kernel_constraint : Optimizer에 의해 업데이트 된 이후에 가중치에 적용되는 부가적인 제약 함수</b> <b> <br /></b>
              <br /><br />
            </li>
                        <li>
              <div class="u-list-icon">
              ...
              <b>bias_constraint : Optimizer에 의해 업데이트된 이후에 편향에 적용되는 부가적인 제약 함수 </b> <b> <br /></b>
              <br /><br />
            </li>
          ...
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp; 우리는 입력값에 대해 활성화 함수인 시그모이드 함수를 사용할 것이고, 
                  출력값은 10개의 값을 출력하는 Fully Connected Layer(완전 연결 계층)를 구현해 봅시다.
                  10개의 노드를 가지는 은닉층과 마지막 출력 값으로 2개의 노드가 있는 신경망의 예는 아래와 같을 것이다.
                  사용법은 이렇게 굉장히 간단하기 때문에 꼭 익혀둡시다.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class=" u-list-1">
            ...
            >
              ...
              >
                <h6 class="u-text u-text-default u-text-1">Code</h6>
                <blockquote class="u-border-grey-50 u-text u-text-2">
                  inputs = tf.keras.layers.Input(shape = (20, 1))  # input size를 넣어주면 된다.<br />
                  hidden = tf.keras.layers.Dense(units = 10, activation = tf.nn.sigmoid)(inputs)<br />
                  output = tf.keras.layers.Dense(units = 2, activation = tf.nn.sigmoid)(hidden)<br />
                </blockquote>
              </div>
            </div>
          </div>
