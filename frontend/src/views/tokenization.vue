<template>
  <div>
    <div class="u-body">
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-4">
                  자연어 처리에 있어서 텍스트 전처리는 매우 중요하다. 왜냐하면
                  사용하는 목적에 따라 전처리를 다르게 해야하기 때문이다.
                  전처리를 위한 여러 기법에 대해 알아보자.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp;토큰화란 말뭉치(corpus)에서 토큰(token)이라 불리는
                  단위로 나누는 작업입니다. 토큰의 단위는 보통 의미를 가지는
                  단위로 선정됩니다. 이때, 토큰의 단위를 단어(word)로 잡으면
                  Word Tokenization이라하고, 문장(sentence)으로 잡으면 Sentence
                  Tokenization이라고 합니다. 우리가 토큰화 시 다음의 두 가지를
                  중점적으로 생각해야 합니다.
                </p>
                <ul class="u-text u-text-2">
                  <li>어떤 기준으로 토큰을 나눌 것인가?</li>
                  <li>어떤 구두점(punctuation)을 제외 할 것인가?</li>
                </ul>
                <p class="u-text u-text-2">
                  &nbsp;사실 간단히 생각하면,
                  <b>띄어쓰기 기준</b>으로 토큰을 나누고
                  <b>모든 구두점을 생략</b>하면 쉽게 토큰화가 된다고 생각 할 수
                  있다.
                </p>
                <hr />
                <hr />
                ...
                <p class="u-text u-text-2">
                  &nbsp;영어와 다르게 한국어에서는 조사가 존재합니다. 예를 들어
                  "나는", "나에게", "나를"과 같은 이런 단어가 다른 단어로
                  인식되면 자연어처리가 힘들다. 따라서 한국어 토큰화에서는
                  형태소(morpheme)란 개념을 반드시 이해해야 합니다. 우선은
                  아래의 두 가지 형태소를 이해해 봅시다.
                </p>
                <ul class="u-text u-text-2">
                  <li>
                    자립 형태소 : 체언(명사, 대명사, 수사), 수식언(관형사,
                    부사), 감탄사 와 같이 그 자체로 단어가 되어 자립하리 수 있는
                    형태소를 나타낸냅니다.
                  </li>
                  <li>
                    의존 형태소 : 접사, 어미, 조사, 어간과 같이 다른 형태소와
                    결합하여 사용되는 형태소를 나타냅니다.
                  </li>
                </ul>
                <p class="u-text u-text-2">
                  &nbsp;즉, 한국어는 영어와 비슷한 토큰화를 얻기 위해서는 어절
                  토큰화가 아닌 <b>형태소 토큰화</b>를 해야합니다.
                </p>
                <hr />
                <hr />
                <p class="u-text u-text-2">
                  &nbsp;<b
                    >한국어는 띄어쓰기를 하지 않아도 글을 이해 할 수
                    있습니다.</b
                  >
                  따라서 영어와는 다른 토큰화가 필요합니다. 이러한 특성들은
                  나라마다 다르고 언어마다 다르기 때문에 반드시 자연어처리를
                  하려는 언어에 대한 특정을 이해하는 것이 필요합니다.
                </p>
                <hr />
                <hr />
                <p class="u-text u-text-2">
                  &nbsp;그렇다면 어떻게 하면 이러한 어려움을 해결 할 수
                  있을까요? 기본적으로 우리는
                  <b>품사 태깅(part-of-speech tagging)</b>을 사용하여, 단어를
                  형태소 토큰화를 하고 추가로 각 단어가 어떤 품사로 쓰였는지도
                  태깅하여 문제를 해결합니다. 그러면 어떻게 하는지 실습으로
                  알아봅시다.
                </p>
                <hr />
                <hr />
                ...
                <p class="u-text u-text-2">
                  &nbsp;우리는 KoNLPy(코엔엘파이)라는 파이선 패키지를 사용하여
                  한국어 자연어 처리를 합니다. KoNLPy를 통해 사용할 수 있는
                  형태소 분석기는 Okt(Open Korea Text), Mecab(메캅),
                  Komoran(코모란), Hannanum(한나눔), 꼬꼬마(Kkma)가 있습니다.
                </p>
                <hr />
                <hr />
                <p class="u-text u-text-2">
                  &nbsp; 성능을 비교해 보면, Mecab(=은전한닢)이 다른 분석기 대비
                  속도가 빠르다. 그래서 주로 Mecab을 사용한다. 어떤 형태소
                  분석기를 사용할지는 자신이 가진 데이터로 분석을 해보고 속도나
                  품질을 비교해 보는 것을 추천드립니다. 그렇다면 사용법에 대해
                  알아봅시다.
                </p>
      ...
      <section class="u-clearfix u-grey-5 u-section-3" id="sec-df45">
        <div class="u-clearfix u-sheet u-sheet-1">
          <div class="u-list u-repeater u-list-1">
            <div
              class="u-container-style u-grey-5 u-list-item u-repeater-item u-shape-rectangle"
            >
              <div
                class="u-container-layout u-similar-container u-container-layout-1"
              >
                <h6 class="u-text u-text-default u-text-1">Code</h6>
                <blockquote class="u-border-black-50 u-text u-text-2">
                  # konlpy 설치 <br />pip install --upgrade pip <br />
                ...
                <br />
                <p class="u-text u-text-2">
                  &nbsp;각각의 분석기를 사용한 예시는 아래와 같습니다. 코드는
                  Colab기준으로 작성하였고 각각의 분석기를 직접 사용해 보길
                  권장합니다.
                </p>
                <br />
                <br />
                ...
                <h4>Okt(Open Korea Text)</h4>
                <br />
                <blockquote class="u-border-blue-50 u-text u-text-2">
                  from konlpy.tag import Okt <br />
                  okt=Okt() <br />
                  text = "싸피에서 열공한 우린, 대한민국을 이끌 IT인재"<br />
                  print(okt.morphs(text))<br />
                  print(okt.pos(text)) <br />
                  print(okt.nouns(text)) <br />

                  > ['싸', '피에서', '열공', '한', '우린', ',', '대한민국',
                  '을', '이끌', 'IT', '인재']<br />
                  > [('싸', 'VerbPrefix'), ('피에서', 'Verb'), ('열공', 'Noun'),
                  ('한', 'Josa'), ('우린', 'Noun'), (',', 'Punctuation'),
                  ('대한민국', 'Noun'), ('을', 'Josa'), ('이끌', 'Verb'), ('IT',
                  'Alpha'), ('인재', 'Noun')]<br />
                  > ['열공', '우린', '대한민국', '인재']<br />
                </blockquote>
                <br />
                ...
                <blockquote class="u-border-blue-50 u-text u-text-2">
                  ...
                  komoran=Komoran() <br />
                  text = "싸피에서 열공한 우린, 대한민국을 이끌 SW인재"<br />
                  print(komoran.morphs(text))<br />
                  print(komoran.pos(text)) <br />
                  print(komoran.nouns(text)) <br />

                  > ['싸', '아', '피', '에서', '열', '공', '하', 'ㄴ', '우리',
                  'ㄴ', ',', '대한민국', '을', '이끌', 'ㄹ', 'SW', '인재']<br />
                  > [('싸', 'VV'), ('아', 'EC'), ('피', 'NNG'), ('에서', 'JKB'),
                  ('열', 'NNG'), ('공', 'NNG'), ('하', 'XSV'), ('ㄴ', 'ETM'),
                  ('우리', 'NP'), ('ㄴ', 'JX'), (',', 'SP'), ('대한민국',
                  'NNP'), ('을', 'JKO'), ('이끌', 'VV'), ('ㄹ', 'ETM'), ('SW',
                  'SL'), ('인재', 'NNG')]<br />
                  > ['피', '열', '공', '대한민국', '인재']<br />
                </blockquote>
                ...
                <br />
                <blockquote class="u-border-blue-50 u-text u-text-2">
                  from konlpy.tag import Hannanum<br />
                  tokenizer=Hannanum() <br />
                  text = "싸피에서 열공한 우린, 대한민국을 이끌 SW인재"<br />
                  print(tokenizer.morphs(text))<br />
                  print(tokenizer.pos(text)) <br />
                  print(tokenizer.nouns(text)) <br />

                  > ['싸피', '에서', '열공한', '우', '이', '리ㄴ', ',',
                  '대한민국', '을', '이끌', 'ㄹ', 'SW', '인재']<br />
                  > [('싸피', 'N'), ('에서', 'J'), ('열공한', 'N'), ('우', 'N'),
                  ('이', 'J'), ('리ㄴ', 'E'), (',', 'S'), ('대한민국', 'N'),
                  ('을', 'J'), ('이끌', 'P'), ('ㄹ', 'E'), ('SW', 'F'), ('인재',
                  'N')]<br />
                  > ['싸피', '열공한', '우', '대한민국', '인재']<br />
                </blockquote>
                <br />
                ...
                <br />
                <blockquote class="u-border-blue-50 u-text u-text-2">
                  from konlpy.tag import Kkma<br />
                  tokenizer=Kkma() <br />
                  text = "싸피에서 열공한 우린, 대한민국을 이끌 SW인재"<br />
                  print(tokenizer.morphs(text))<br />
                  print(tokenizer.pos(text)) <br />
                  ...
                  '대한민국', '을', '이끌', 'ㄹ', 'SW', '인재']<br />
                  > [('싸', 'VV'), ('아', 'ECS'), ('피', 'NNG'), ('에서',
                  'JKM'), ('열', 'NNG'), ('공한', 'NNG'), ('우리', 'VV'), ('ㄴ',
                  'ETD'), (',', 'SP'), ('대한민국', 'NNG'), ('을', 'JKO'),
                  ('이끌', 'VV'), ('ㄹ', 'ETD'), ('SW', 'OL'), ('인재',
                  'NNG')]<br />
                  > ['피', '열', '열공한', '공한', '대한', '대한민국', '민국',
                  '인재']<br />
                </blockquote>
                ...
                <blockquote class="u-border-blue-50 u-text u-text-2">
                  from konlpy.tag import Mecab<br />
                  tokenizer= Mecab()<br />
                  text = "싸피에서 열공한 우린, 대한민국을 이끌 SW인재"<br />
                  print(tokenizer.morphs(text))<br />
                  print(tokenizer.pos(text)) <br />
          ...
          <ul class="u-custom-list u-text u-text-3">
            <li>
              ...
              <b
                >Mecab(은전한닢)은 import Kkma로 사용이 불가능하기 때문에 따로
                설치가 필요하다.</b
              >
              <br /><b> <br /></b>
            </li>
            ...
            <blockquote class="u-border-blue-50 u-text u-text-2">
              ! git clone
              https://github.com/SOMJANG/Mecab-ko-for-Google-Colab.git<br />
              ! bash
              Mecab-ko-for-Google-Colab/install_mecab-ko_on_colab190912.sh<br />
            </blockquote>
          </ul>
        </div>
      </section>
