<template>
  <div>
    <div class="u-body">
      <section class="u-align-center u-clearfix u-section-1" id="carousel_a3ed">
        <div class="u-clearfix u-sheet u-sheet-1">
          <h6 class="u-text u-text-default u-text-1">TUTORIAL</h6>
          <h2 class="u-text u-text-default u-text-2">
            <b>모델</b> 만들기<br />
          </h2>
          <div class="u-list u-repeater u-list-1">
            <div
              class="u-container-style u-expanded-width u-list-item u-repeater-item u-shape-rectangle"
            >
              <div
                class="u-container-layout u-similar-container u-valign-bottom-sm u-container-layout-1"
              >
                <h4 class="u-text u-text-3">목표</h4>
                <p class="u-text u-text-4">
                  Tensorflow 2.0 버전에서 케라스를 이용하여 
                  <b>모델을 생성</b>하는 방법을 알아보고 <b>구현</b>하는 과정을 통해 모델을 구축해보자.
                </p>
              </div>
            </div>
          </div>
          <span class="u-icon u-icon-circle u-text-palette-1-base u-icon-1"
            ...
            >
              <rect style="fill:#E7ECED;" width="58" height="58"></rect>
              <polyline
      ...
      <section class="u-clearfix u-section-2" id="sec-2991">
            ...
            >
              ...
              >
                <h4 class="u-text u-text-default u-text-1">
                  1단계. tensorflow의 버전 알아보기
                </h4>
                <p class="u-text u-text-2">
                  &nbsp;구글링을 해서 tensorflow관련 코드를 찾아서 colab에서 진행해보면 안되는 경우가 있습니다. 
                  특히 session.run()에서 에러가 발생하는 것을 자주 확인 할 수 있습니다. 
                  그러한 이유는 우리는 버전 tensorflow 2.x 버전을 사용하는데, 
                  tensorflow 1.x 버전의 코드를 사용하여 발생한 에러입니다. 
                  tensorflow 2버전으로 오르면서 생긴 가장 큰 변화는 API Cleanup이 되었다는 것입니다. 
                  버전 1 때는 같은 기능을 수행하는 다양한 API가 다양한 패키지 속에 중복으로 있었습니다. 
                  이러한 동일한 기능을 하는 API를 통합하고 잘 사용하지 않는 API를 제거했습니다.
                  <br />
                  <br />
                  &nbsp;두번째로는 생긴 변화는 Eager execution입니다. 
                  버전 1에서는 텐서플로 API를 이용해 그래프를 만든 후 별도 세션을 통해 그래프를 실해해야 했습니다. 
                  그래서 버전 1에서는 session.run()을 통해 그래프를 추가로 실행해야한 연산의 결과를 알 수 있었습니다. 
                  그러나 버전2.0 부터는 파이썬과 동일한 eager 모드가 실행되기 때문에 세션을 불러올 필요없이 바로바로 값을 확인 할 수 있습니다.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp;텐서플로우 2.0부터는 keras를 활용하여 모델을 구축하고 
                  학습하는 것을 권장합니다. keras를 활용해 모델을 구축하는 방법은 아래와 같습니다.
                  <br />
                ...
                <ol>
                  ...
                  <li>
                    Functional/Sequential API  + Custom Layer
                  </li>
                  <li>
                  ...
                  <br />
                  &nbsp;우리는 이러한 방법 가운데 Subclassing을 주로 이용해 모델을 구축하게 될 것입니다.
          ...
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp; tf.keras.Sequential은 케라스를 활용해 모델을 구축할 수 있는 가장 간단한 형태의 API입니다. 
                  Sequential 모듈을 이용하면 간단한 순차적인 레이어의 스택을 구현할 수 있습니다. 
                  다음은 Suquential 모듈을 이용하여 fully-connected layer를 구현한 것입니다.
                  <br />
                </p>
              </div>
            </div>
      ...
      <section class="u-grey-5 u-section-3" id="">
        <div class="">
          <div class=" u-list-1">
            <div
              class=""
            >
              <div
                class=" u-container-layout-1"
              >
                <h6 class="u-text u-text-default u-text-1">Code</h6>
                <blockquote class="u-border-grey-50 u-text u-text-2">
          ...
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp;위의 예와 같이 Sequential 모듈의 경우 구현이 매우 쉽습니다. 
                  단지, Sequential 인스턴스를 생성 후에 인스턴스에 순차적으로 layer를 더해주면 모델이 완성됩니다. 
                  <br /><br />
                  softmax 함수란, 인공신경망에서 출력된 K개의 클래스 구분 결과를 확률처럼 해석하도록 만들어주고,
                   relu 함수는 음수값을 0으로 만들어서 학습을 훨씬 빠르게 만들어 줍니다.
                  <br /><br />
                  그러나 Sequential 모듈의 경우, 모든 모델을 구현 할 수 있는 것은 아닙니다. 
                  예를들면 VQA(Visual Question Answering) 문제, 사진과 질문이 입력값으로 주어지고 
                  질문에 답해야하는 경우는
                   특징을 뽑아주는 두 레이어가 각각 순차적으로 존재하기 때문에 
                   Suquential 모듈이 사용 불가능합니다. 
                   <b>즉, Suquential 모듈은 하나의 플로만 계산가능합니다.</b> 
                   
                   두 개의 플로를 계산하기 위해서는 아래의 다른 모델을 사용하도록 합시다.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp;   앞에서 본 Sequential 모듈은 간단한 레이어들의 스택 구조에 적합합니다. 
                  그러나 복잡한 모델의 경우에는 구현의 제약이 있다는 것을 알 수 있습니다. 
                  구현제약의 예는 아래와 같습니다.
                  <br />
                <ol>
                  <li>
                  ...
                  &nbsp; 이러한 모델을 구현 시 Fuctional API를 사용하거나 Subclassing 방식을 
                  사용하는 것이 적절합니다. 이제 Functional API를 활용해서 앞에서
                   정의한 모델과 동일한 모델을 만들어 봅시다자.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class=" u-list-1">
            ...
            >
              ...
              >
                ...
                x = layers.Dense(64, activation='relu')(inputs) <br />
                x = layers.Dense(64, activation='relu')(x) <br />
                predictions = layers.Dense(10, activation='softmax')(x) <br />
                </blockquote>
              </div>
            </div>
          </div>
        ...
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                <p class="u-text u-text-2">
                  &nbsp;Functional API를 활용하기 위해서는 입력값을 받는 Input 모듈을 선언해야한다. <br />
                  그리고 input 모듈을 선언 시에 모델의 입력으로 받는 값의 형태(shape)를 정의해 줘야한다. <br />
                  정의한 후에 입력값을 적용할 레이어를 호출할 때 인자로 전달하는 방식을 구현해 주면 된다. <br />
          ...
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp;  이 부분을 모델이 아니라 모델에 들어갈 Custom layer(사용자 layer)를 만드는 부분입니다.
                  custom model은 아래에 나옵니다.
                  <br />
                  <br />
                  &nbsp;  이 부분을 모델이 아니라 모델에 들어갈 Custom layer(사용자 layer)를 만드는 부분입니다.
                  custom model은 아래에 나옵니다.
            ...
            >
              ...
              >
                ...
                <blockquote class="u-border-grey-50 u-text u-text-2">
                  ...
                  class CustomLayer(layers.Layer):<br />
                  &nbsp; &nbsp; &nbsp; &nbsp; def __init__(self, hidden_dimension, hidden_dimension2, output_dimension):<br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.hidden_dimension = hidden_dimension<br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.hidden_dimension2 = hidden_dimension2<br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.output_dimension = output_dimension<br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;super(CustomLayer, self).__init__() # super은 상속받은 Layer에서의 init를 여기서 실행하도록 한다.<br />
                          <br /><br />
                      &nbsp;&nbsp;&nbsp;&nbsp;def build(self, input_shape):<br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.dense_layer1 = layers.Dense(self.hidden_dimension, activation= 'relu')<br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.dense_layer2 = layers.Dense(self.hidden_dimension2, activation= 'relu')<br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.dense_layer3 = layers.Dense(self.output_dimension, activation= 'softmax')<br />
                          <br /><br />
                      &nbsp;&nbsp;&nbsp;&nbsp;def call(self, inputs):<br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x = self.dense_layer1(inputs)<br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x = self.dense_layer2(x)<br />
                          <br /><br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return self.dense_layer3(x)<br />
        ...
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                <p class="u-text u-text-2">
                  &nbsp;사용자 측을 정의 시 먼저 layers 패키지의 Layer 클래스를 상속받고, 위와 같이 3개의 메서드를 정의해주면 됩니다. <br />
                  <ul>
                    <li>
                      하이퍼파라미터는 객체를 생성할 때 호출되도록 __init__ 메서드에서 정의합니다.
                    </li>
                    <li>
                      모델의 가중치와 관련된 값은 build 메서드에서 생성되도록 정의합니다.
                    </li>
                    <li>
                      위의 정의한 메서드를 이용해 call 메서드에서 해당 층의 로직을 정의하면 됩니다.
                    </li>
                  </ul>
                  <br /><br />

                  &nbsp;Custom Layer를 정의하면 Sequential API이나 Functional API를 활용 시 하나의 층으로 사용할 수 있습니다. 
                  위에서 정의한 CustomLayer를 Sequential 모듈을 활용한다면 다음과 같습니다.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <blockquote class="u-border-grey-50 u-text u-text-2">
                  ...
                  model = tf.keras.Sequential()<br />
                  model.add(CustomLayer(64, 64, 10))<br />
          ...
          <div class="u-list u-repeater u-list-1">
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp;   이 부분이 우리가 가장 많이 활용하는 방법이고, 자유도가 가장 높습니다. 
                  이 경우는 tf.keras.Model을 상속받고 모델 내부 연산들을 직접 구현하면 됩니다. 
                  모델 클래스를 구현 시 객체를 생성할 때 호출되는 __init__ 메서드와 생성된 인스턴스를 호출해여 
                  모델 연산 시 호출되는 call 메서드만 구현해주면 됩니다. 
                  <br />
                  <br />
                  &nbsp;  구현한 모델을 Model 클래스로 상속받아 구현해 봅시다.
                  <br />
                </p>
              </div>
            </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;def __init__(self, hidden_dimension, hidden_dimension2, output_dimension):<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;super(MyModel, self).__init__(name='my model')<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.dense_layer1 = layers.Dense(hidden_dimension, activation= 'relu')<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.dense_layer2 = layers.Dense(hidden_dimension2, activation= 'relu')<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.dense_layer3 = layers.Dense(output_dimension, activation= 'softmax')<br /><br />
        
&nbsp;&nbsp;&nbsp;&nbsp;def call(self, inputs):<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x = self.dense_layer1(inputs)<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x = self.dense_layer2(x)<br /><br />
        
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return self.dense_layer3(x)<br /><br />
            ...
            >
              ...
              >
                <p class="u-text u-text-2">
                  <ul>
                    <li>
                      __init__ 매서드를 통해 모델에 사용될 층과 변수를 정의합니다.
                    </li>
                    <li>
      ...
      <section
        class="u-align-center-lg u-align-center-md u-align-center-xl u-align-left-xs u-align-right-sm u-clearfix u-image u-section-9"
        id="carousel_a316"
      >
        <div class="u-clearfix u-sheet u-sheet-1">
          <div class="u-expanded-width u-list u-repeater u-list-1">
            <div
              class="u-border-5 u-border-palette-2-base u-container-style u-image u-list-item u-repeater-item u-video-cover u-image-1"
            ...
            >
              ...
              >
                <p
                  class="u-custom-font u-font-montserrat u-text u-text-palette-2-base u-text-1"
                >
                  01
                </p>
                <p class="u-text u-text-grey-70 u-text-2">
                  text classification
                </p>
                <p class="u-text u-text-grey-50 u-text-3">
                  We serve the highest quality of prepared meals at a great
                  value, in a home-like and friendly environment.
                </p>
                <a
                  href="#"
            ...
            <div
              class="u-border-5 u-border-palette-2-base u-container-style u-image u-list-item u-repeater-item u-image-2"
              data-image-width="1980"
              data-image-height="874"
            >
              <div
              ...
              >
                <p
                  class="u-custom-font u-font-montserrat u-text u-text-palette-2-base u-text-4"
                >
                  02
                </p>
                ...
                <p class="u-text u-text-grey-50 u-text-6">
                  We use cookies and similar tracking and storage technologies
                  on our site to enhance your user experience
                </p>
                <a
                  href="#"
            ...
            <div
              class="u-border-5 u-border-palette-2-base u-container-style u-image u-list-item u-repeater-item u-video-cover u-image-3"
              data-image-width="1980"
              data-image-height="874"
            >
              <div
              ...
              >
                <p
                  class="u-custom-font u-font-montserrat u-text u-text-palette-2-base u-text-7"
                >
                  03
                </p>
                <p class="u-text u-text-grey-70 u-text-8">
                  bert classification
                </p>
                <p class="u-text u-text-grey-50 u-text-9">
                  A light, sour wheat dough with roasted walnuts and freshly
                  picked rosemary, thyme, poppy seeds, parsley and sage
                </p>
                <a
                  href="#"
      ...
      >
        <div class="u-clearfix u-sheet u-sheet-1">
          <p class="u-small-text u-text u-text-variant u-text-1">
            If you want to be more information, contact about
            aaakch0316@gmail.com
          </p>
        </div>
      </footer>
    </div>
...
.u-text:not(ul):not(ol):not(p):not(.u-post-content):not(.u-block-content):not(.u-product-desc)
  a {
  color: inherit;
}
.u-text:not(ul):not(ol):not(p):not(.u-post-content):not(.u-block-content):not(.u-product-desc)
...
.u-section-3 .u-text-2 {
  ...
  margin: -22px 38px 0 140px;
}

.u-section-3 .u-text-3 {
  margin: 0 86px 60px 326px;
}
...
.u-section-9 {
  background-image: url("../assets/images/wd-min.jpg");
  background-position: 50% 50%;
}
...
.u-section-9 .u-list-1 {
  min-height: 409px;
  grid-template-columns: calc(33.3333% - 20px) calc(33.3333% - 20px) calc(
      33.3333% - 20px
    );
  grid-gap: 30px 30px;
  margin: 60px 0 0;
