<template>
  <div>
    <div class="u-body">
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-4">
                  Tensorflow 2.0 버전에서 케라스를 이용하여 <b>전처리</b> 후에
                  <b>모델을 생성</b>하고 <b>학습</b>하는 과정을 거시적으로
                  이해하고 구현해 봅시다.
                </p>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp;컴퓨터는 한국어를 이해할 수 없습니다. 그래서 Deep
                  learning을 하기 위해 한국어를 컴퓨터가 이해할 수 있게 Vector로
                  변환하는 과정이 필요합니다. 이를 우리는 전처리라고 하거나,
                  또는 입력값을 임베딩된 벡터로 변형한다라고도 합니다.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            >
              ...
              >
                ...
                <blockquote class="u-border-grey-50 u-text u-text-2">
                  import tensorflow as tf <br />from tensorflow.keras import
                  preprocessing <br />
                  <br />samples = [<font style="font-size: 0.875rem;"
                    >'날이 좋아, 기분이 너무 좋다', <br />&nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; '오늘
                    기분이 별로야', <br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; '프로젝트 너무 힘들어',
                    ...
                    &nbsp; &nbsp; &nbsp; '영민햄은 너무 즐거워 </font
                  >'] <br />
                  <br />labels = [[1], [0], [0], [1], [1]] <br />tokenizer =
                  preprocessing.text.Tokenizer()
                  <br />tokenizer.fit_on_texts(samples) <br />sequences =
                  tokenizer.texts_to_sequences(samples) <br />
                  <br />word_index = tokenizer.word_index
                </blockquote>
              </div>
            </div>
          </div>
          <ul class="u-custom-list u-text u-text-3">
            <li>
              ...
              <b>import tensorflow as tf </b> <br />&gt; tensorflow 모듈을
              가져와서 tf로 사용할 수 있게 만들어 줍니다. <br /><b> <br /></b>
            </li>
            <li>
              <div class="u-list-icon">
                <svg
              ...
              <b>from tensorflow.keras import preprocessing <br /></b>&gt;
              아래의 text module을 사용하기 위해 tensorflow.keras 에서
              preprocessing utils를 가져옵니다. <br /><b> <br /></b>
            </li>
            <li>
              <div class="u-list-icon">
                <svg
            ...
            <li>
              ...
              <b>labels = [[1], [0], [0], [1], [1]] </b> <br />&gt; 우리는 지금
              긍정과 부정으로 두 가지 나눠서 분류를 하고 있기 때문에, samples
              값에 맞게 긍정은 [1], 부정은 [0]으로 만들어 준 것이다. 이러한 두
              가지 분류를 영어로 binary classification이라고도 합니다. <br />
              <br />
            </li>
            <li>
              <div class="u-list-icon">
              ...
              <b>tokenizer = preprocessing.text.Tokenizer() </b> <br />&gt;
              tf.keras.preprocessing.text 모듈은 Tokenizer 클래스를 포함합니다.
              Tokenizer 클래스를 사용하여 tokenizer 인스턴스를 만들어 줍니다.
              <br />
              <br />
            </li>
            <li>
              ...
              <b>tokenizer.fit_on_texts(samples) </b> <br />&gt; tokenizer
              인스턴스에 fit_on_texts를 사용하여 텍스트로 이루어진 리스트를
              토대로 내부 단어를 업데이트 합니다. 아래의 texts_to_sequences나
              texts_to_matrix를 사용하기 전에 fit_on_texts를 적용해 줘야합니다.
              <br />
              <br />
            </li>
            <li>
              ...
              <b>sequences = tokenizer.texts_to_sequences(samples) </b>
              <br />&gt; texts_to_sequences는 samples에 들어간 text를 integers로
              이루어진 숫자의 시퀀스 형태로 바꿔준다. <br />
              <br />
            </li>
            <li>
              <div class="u-list-icon">
              ...
              <b>word_index = tokenizer.word_index </b> <br />&gt; word_index의
              속성은 단어와 숫자가 딕셔너리의 key와 value 쌍으로 바꿔줍니다.<br />
            </li>
          </ul>
        </div>
      </section>
      <section class="u-clearfix u-section-4" id="carousel_e291">
        <div class="u-clearfix u-sheet u-sheet-1">
          <div class="u-list u-repeater u-list-1">
            <div
              class="u-container-style u-list-item u-repeater-item u-shape-rectangle"
            >
              ...
              >
                ...
                <p class="u-text u-text-2">
                  &nbsp;심층 신경망 모델을 만드는 방법에는 Sequential API 방법과
                  Function API 방법이 있습니다. 우리는 Sequential API 방법을
                  활용하여 모델을 만들어 봅시다. 모델의 만드는 원리는 거름종이를
                  한 층씩 만들어서 한 층씩 통과시키는 것이라고 생각해 주시면
                  됩니다. 먼저 Sequential()을 선언 후에 layer를 하나씩 쌓아준다.
                </p>
              </div>
            </div>
          </div>
      ...
      <section class="u-clearfix u-grey-5 u-section-5" id="carousel_7e1c">
        <div class="u-clearfix u-sheet u-sheet-1">
          <div class="u-list u-repeater u-list-1">
            <div
              class="u-container-style u-grey-5 u-list-item u-repeater-item u-shape-rectangle"
            >
              ...
              >
                <blockquote class="u-border-grey-50 u-text u-text-1">
                  model = tf.keras.Sequential()
                  <br />model.add(layers.Embedding(vacab_size, emb_size,
                  input_length = 4)) <br />model.add(layers.Lambda(lambda x:
                  tf.reduce_mean(x, axis = 1)))
                  <br />model.add(layers.Dense(hidden_dimension,
                  activation='relu'))
                  <br />model.add(layers.Dense(output_dimension,
                  activation='sigmoid'))
                </blockquote>
                <h6 class="u-text u-text-default u-text-2">Code</h6>
              </div>
            </div>
          </div>
          <ul class="u-custom-list u-text u-text-3">
            ...
            <li style="">
              model = tf.keras.Sequential()Sequential <br />&gt; 객체를 생성한
              후에 아래에 각 층을 추가하면 됩니다.<br />
              <br />
            </li>
            <li style="">
              <div class="u-list-icon">
              ...
              model.add(layers.Embedding(vacab_size, emb_size, input_length =
              4))<br />&gt; Embedding층으로 입력값을 임베딩하는 부분입니다.<br />
              <br />
            </li>
            <li style="">
              <div class="u-list-icon">
              ...
              model.add(layers.lambda(lambda x: tf.reduce_mean(x, axis = 1)))<br />&gt;
              임베딩된 각 단어는 하나의 층으로 되어있지 않습니다. 그래서 다음
              층에 넣기 위해 입력값들의 평균을 내어 다름 layer에 넣어주는
              처리과정이 필요합니다. 즉, 벡터를 평균하기 위해 람다(Lambda) 층을
              넣은 것입니다.<br />
              <br />
            </li>
            <li style="">
              ...
              model.add(layers.Dense(hidden_dimension, activation='relu'))<br />&gt;
              hidden layer는 layer들 사이의 가운데 들어간 layer어라고 생각해
              주면 됩니다.<br />
              <br />
            </li>
            <li style="">
              ...
              model.add(layers.Dense(output_dimension, activation='sigmoid'))<br />&gt;
              activation은 활성화 함수를 넣는 것이라고 생각하면 됩니다. 여기서
              sigmoid 함수는 출력값의 합이 1이되게 만들어, 각각의 값이 0과
              1사이로 만들어 확률을 비교 할 수 있게 합니다.<br />
            </li>
          </ul>
        </div>
      </section>
      <section class="u-clearfix u-section-6" id="carousel_7c07">
        <div class="u-clearfix u-sheet u-sheet-1">
          <div class="u-list u-repeater u-list-1">
            <div
              class="u-container-style u-list-item u-repeater-item u-shape-rectangle"
            >
              <div
                class="u-container-layout u-similar-container u-container-layout-1"
              >
                <h4 class="u-text u-text-1">3단계. 학습하기</h4>
                <p class="u-text u-text-2">
                  학습하기 위해서는 Keras 내장 API인 compile 메서드와 fit
                  메서드를 사용하면 됩니다. 우선은 Compile 매서트를 사용해
                  학습과정을 정의해 봅시다.
                </p>
              </div>
            </div>
      ...
      <section class="u-clearfix u-grey-5 u-section-7" id="carousel_2831">
        <div class="u-clearfix u-sheet u-sheet-1">
          <div class="u-list u-repeater u-list-1">
            <div
              class="u-container-style u-grey-5 u-list-item u-repeater-item u-shape-rectangle"
          ...
          <ul class="u-custom-list u-text u-text-3">
            ...
            <li style="">
              optimizer의 경우 아담(Adam) 최적화 알고리즘을
              사용했습니다.&nbsp;<br />
              <br />
            </li>
            <li style="">
              ...
              이진 분류 문제에서 loss값으로는 binary cross-entropy(이진 교차
              엔트로피 손실 함수)를 사용합니다다.&nbsp;<br />
              <br />
            </li>
            <li style="">
              <div class="u-list-icon">
              ...
              &nbsp;metrics 부분은 모델의 성능을 측정하기 위한 기준인 평가지표를
              정의하는데, 이진 분류의 평가 지표로 가장 널리 사용되는
              accuracy(정확도)를 평가 지표로 사용합니다.<br />
            </li>
          </ul>
        </div>
      </section>
      <section class="u-clearfix u-grey-5 u-section-8" id="carousel_07db">
        <div class="u-clearfix u-sheet u-sheet-1">
          <div class="u-list u-repeater u-list-1">
            <div
              class="u-container-style u-grey-5 u-list-item u-repeater-item u-shape-rectangle"
